...
import { FileText, Package, Truck, Clock, Filter } from 'lucide-react';
...
const modelIcons: Record<string, typeof Package> = {
  Inventory: Package,
  Dispatch: Truck,
};
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Track all inventory and dispatch activities</p>
        </div>
        <Button
          variant="outline"
        ...
        <Card>
          ...
          <CardContent>
            ...
            <div className="mt-4 flex gap-2">
              <Button
                variant="outline"
                onClick={() => setFilters({ action: '', model_type: '', from: '', to: '' })}
              >
                Clear Filters
              </Button>
            </div>
            ...
            <TableBody>
              {isLoading ? (
                ...
                data?.data?.map((log) => {
                  ...
                  const ModelIcon = modelIcons[log.model_type] || FileText;
