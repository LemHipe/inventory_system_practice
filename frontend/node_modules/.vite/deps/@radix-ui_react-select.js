...
import {
  ...
  useFocusGuards,
  useId
} from "./chunk-CTOBLNWI.js";
import {
  composeEventHandlers,
  useCallbackRef,
  useLayoutEffect2
} from "./chunk-TGKPKOI6.js";
import {
  require_react_dom
...
function createSlot4(ownerName) {
  ...
  const Slot22 = React14.forwardRef((props, forwardedRef) => {
    ...
    if (slottable) {
      ...
      return (0, import_jsx_runtime13.jsx)(SlotClone, { ...slotProps, ref: forwardedRef, children: React14.isValidElement(newElement) ? React14.cloneElement(newElement, void 0, newChildren) : null });
    }
...
var SelectIcon = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime18.jsx)(Primitive3.span, { "aria-hidden": true, ...iconProps, ref: forwardedRef, children: children || "▼" });
  }
);
...
var SelectContentImpl = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    useFocusGuards();
    const focusFirst = React20.useCallback(
      (candidates) => {
    ...
    return (0, import_jsx_runtime18.jsx)(
      SelectContentProvider,
      {
        ...
        isPositioned,
        searchRef,
        children: (0, import_jsx_runtime18.jsx)(Combination_default, { as: Slot6, allowPinchZoom: true, children: (0, import_jsx_runtime18.jsx)(
          FocusScope,
          {
            asChild: true,
...
var SelectGroup = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    const groupId = useId();
    return (0, import_jsx_runtime18.jsx)(SelectGroupContextProvider, { scope: __scopeSelect, id: groupId, children: (0, import_jsx_runtime18.jsx)(Primitive3.div, { role: "group", "aria-labelledby": groupId, ...groupProps, ref: forwardedRef }) });
  }
);
...
var SelectLabel = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime18.jsx)(Primitive3.div, { id: groupContext.id, ...labelProps, ref: forwardedRef });
  }
);
...
var SelectItemText = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime18.jsxs)(import_jsx_runtime18.Fragment, { children: [
      (0, import_jsx_runtime18.jsx)(Primitive3.span, { id: itemContext.textId, ...itemTextProps, ref: composedRefs }),
...
var SelectItemIndicator = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    return itemContext.isSelected ? (0, import_jsx_runtime18.jsx)(Primitive3.span, { "aria-hidden": true, ...itemIndicatorProps, ref: forwardedRef }) : null;
  }
);
...
var SelectSeparator = React20.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime18.jsx)(Primitive3.div, { "aria-hidden": true, ...separatorProps, ref: forwardedRef });
  }
);
